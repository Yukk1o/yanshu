...
In particular: use no `unsafe`, do not weaken fuel or capability boundaries, do not treat the Rust-style review projection as source code, and run the guide's verification gates before handing work back.
