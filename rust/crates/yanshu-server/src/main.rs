...
use yanshu_ops::acquire_service_lease;
...
fn configured_authentication() -> YanshuResult<Option<BearerAuth>> {
    match env::var("YANSHU_HTTP_BEARER_TOKEN") {
...
fn require_loopback(address: SocketAddr) -> YanshuResult<()> {
