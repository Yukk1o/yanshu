...
use ail_diagnostic::{AilResult, Diagnostic, Span};
use ail_syntax::{
...
pub(crate) fn infer_program(program: &Program) -> AilResult<BTreeMap<String, Type>> {
...
impl Inferencer {
    ...
    fn infer(mut self, program: &Program) -> AilResult<BTreeMap<String, Type>> {
    ...
    fn infer_datum(&mut self, datum: &Datum) -> AilResult<Type> {
        match &datum.kind {
    ...
    fn unify(&mut self, left: Type, right: Type, span: Span) -> AilResult<()> {
