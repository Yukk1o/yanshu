...
impl ShadowRuntime {
    ...
    pub fn record(&self, observation: &ShadowObservation) -> yanshu_diagnostic::YanshuResult<()> {
    ...
    pub fn record_unavailable(
        ...
        error_code: String,
    ) -> yanshu_diagnostic::YanshuResult<()> {
    ...
    fn load_candidate(&self) -> yanshu_diagnostic::YanshuResult<Program> {
        self.store
