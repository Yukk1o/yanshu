...
pub(crate) fn measure_runtime_value(value: &Value) -> AilResult<ValueMetrics> {
    let mut measure = ValueMeasure::default();
    measure.visit_value(value, 0, false)?;
    Ok(measure.metrics())
}

pub(crate) fn measure_portable_value(value: &Value) -> AilResult<ValueMetrics> {
    let mut measure = ValueMeasure::default();
    measure.visit_value(value, 0, true)?;
    Ok(measure.metrics())
}

pub(crate) fn measure_datum(datum: &Datum) -> AilResult<ValueMetrics> {
    let mut measure = ValueMeasure::default();
...
impl ValueMeasure {
    ...
    fn bump_node(&mut self, depth: usize) -> AilResult<()> {
    ...
    fn check_collection(&self, length: usize) -> AilResult<()> {
    ...
    fn add_bytes(&mut self, bytes: usize) -> AilResult<()> {
    ...
    fn add_integer(&mut self, value: &BigInt) -> AilResult<()> {
        let bits = value.bits();
    ...
    fn visit_value(&mut self, value: &Value, depth: usize, portable: bool) -> AilResult<()> {
    ...
    fn visit_schema(&mut self, schema: &SchemaKind, depth: usize) -> AilResult<()> {
        self.bump_node(depth)?;
        match schema {
    ...
    fn visit_datum(&mut self, datum: &Datum, depth: usize) -> AilResult<()> {
        self.bump_node(depth)?;
        match &datum.kind {
