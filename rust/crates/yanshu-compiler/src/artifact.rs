...
const BYTECODE_TARGET: &str = "yanshu-bytecode-v1";
...
pub fn compile_bytecode(program: &Program) -> YanshuResult<BytecodeArtifact> {
...
pub fn load_bytecode_envelope(program: &Program, source: &[u8]) -> YanshuResult<BytecodeArtifact> {
...
mod tests {
    ...
    fn program() -> yanshu_syntax::Program {
