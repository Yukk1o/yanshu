...
use crate::{
    ...
    RustEncodingBackend, RustIntegerBackend, RustJsonBackend, RustListBackend, RustMapBackend,
    RustMathBackend, RustTextBackend, RustTextV2Backend, trusted_contract,
};
...
impl LibraryRegistry {
    ...
    pub fn rust_standard() -> Self {
        ...
        registry.backends.insert(
            ...
            RegisteredBackend {
                provider: "rust-std".to_owned(),
                backend: Box::<RustDigestBackend>::default(),
            },
        );
        registry.backends.insert(
            ("json".to_owned(), 1),
            RegisteredBackend {
                provider: "rust-std".to_owned(),
                backend: Box::<RustJsonBackend>::default(),
            },
        );
        registry.backends.insert(
            ("decimal".to_owned(), 1),
        ...
        registry.backends.insert(
            ...
            RegisteredBackend {
                provider: "rust-std".to_owned(),
                backend: Box::<RustMapBackend>::default(),
            },
        );
        registry.backends.insert(
            ("encoding".to_owned(), 1),
            RegisteredBackend {
                provider: "rust-std".to_owned(),
                backend: Box::<RustEncodingBackend>::default(),
            },
        );
        registry.backends.insert(
            ("integer".to_owned(), 1),
            RegisteredBackend {
                provider: "rust-std".to_owned(),
                backend: Box::<RustIntegerBackend>::default(),
            },
        );
        registry
    }
