...
use crate::{LibraryBackend, LibraryContract, LibraryValue, RustTextBackend, trusted_contract};
...
impl LibraryRegistry {
    ...
    pub fn register(&mut self, backend: Box<dyn LibraryBackend>) -> AilResult<()> {
    ...
    pub fn require(&self, library: &str, version: u16) -> AilResult<LibraryContract> {
...
fn validate_provider(provider: &str) -> AilResult<()> {
