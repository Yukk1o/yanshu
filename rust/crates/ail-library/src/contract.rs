...
impl FuelModel {
    pub fn cost(self, arguments: &[LibraryValue]) -> AilResult<u64> {
        match self {
...
impl OperationContract {
    pub fn validate_arguments(self, arguments: &[LibraryValue]) -> AilResult<()> {
    ...
    pub fn validate_result(self, result: &LibraryValue) -> AilResult<()> {
