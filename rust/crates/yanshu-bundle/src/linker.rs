...
) -> YanshuResult<BTreeMap<String, String>> {
...
fn default_span() -> yanshu_diagnostic::Span {
    let position = yanshu_diagnostic::Position {
        offset: 0,
        line: 1,
        column: 1,
    };
    yanshu_diagnostic::Span {
        start: position,
        end: position,
    }
}
