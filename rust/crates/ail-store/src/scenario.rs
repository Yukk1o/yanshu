...
fn read_source(path: &Path) -> AilResult<String> {
...
fn normalize_metadata(metadata: JsonValue) -> AilResult<JsonValue> {
...
fn read_event_names(path: &Path) -> AilResult<Vec<String>> {
